...
def farthest_point_sampling(pcd, k, metrics=l2_norm):
    ...
    farthest_point = points[indices[0]] # (x, y, z) for first point
    min_distances = metrics(farthest_point, points) # farthest_point broadcast
    ...
    for i in range(1, k):
        ...
        # update distances for next point
